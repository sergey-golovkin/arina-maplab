...
public class substring_after extends MapLibraryFunctionProcessor
{
    public substring_after(IMapComponentDefinition definition, Integer growable)
    {
    ...
    protected IMapValue getValueInternal(String index, IMapContext context) throws Exception
    {
        ...
        if(value.isNotNull() && subStr.isNotNull())
        {
            ...
            return new MapValue(this, StringUtils.substringAfter(str, sub).trim());
        }
